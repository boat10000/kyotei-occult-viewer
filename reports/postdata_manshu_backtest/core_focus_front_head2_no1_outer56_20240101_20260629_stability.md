...
- 元台帳: `reports/postdata_manshu_backtest/core_focus_front_head2_no1_outer56_20240101_20260629_ledger.csv`
- 判定: `FORWARD_TEST_OK`
...
segment  buy_races  total_points  stake_yen  payback_yen  profit_yen  roi_pct  hit_rate_pct  manshu_hit_rate_pct  avg_points  max_losing_streak        decision
    ALL         98           310      31000       119070       88070    384.1          7.14                 4.08        3.16                 24 FORWARD_TEST_OK
```
...
```text
         ...
         all_hits             0       119070   384.10                  NaN
without_top_1_hit             1        67290   217.06              51780.0
without_top_2_hit             2        45990   148.35              73080.0
without_top_3_hit             3        26880    86.71              92190.0
without_top_4_hit             4        13540    43.68             105530.0
without_top_5_hit             5         4090    13.19             114980.0
```
