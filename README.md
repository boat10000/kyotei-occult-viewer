...
- `.github/workflows/update-manshu-role.yml` が毎日 09:15 JST と 23:30 JST に実行されます。
- 09:15 は朝版ロール候補、23:30 は結果・配当反映用です。
...
- 展示・気象を含む直前版は、画面スクレイピング負荷を避けるため、必要な場・Rだけ補完する方針です。
